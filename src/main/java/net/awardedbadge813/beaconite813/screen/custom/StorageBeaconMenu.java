...
public class StorageBeaconMenu extends AbstractContainerMenu {

    public final StorageBeaconBlockEntity blockEntity;
    ...
    public StorageBeaconMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.STORAGE_BEACON_MENU.get(), pContainerId);
        this.blockEntity = ((StorageBeaconBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        ...
        pPlayer, ModBlocks.STORAGE_BEACON_BLOCK.get());
    }
}
